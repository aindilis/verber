...
(define
 (domain fffopc)
 (:requirements :typing :disjunctive-preconditions :conditional-effects :equality :durative-actions :fluents :negative-preconditions :derived-predicates :timed-initial-literals)
