...
(define
 ...
 (:requirements :negative-preconditions :typing :derived-predicates :equality :timed-initial-literals :fluents :durative-actions :conditional-effects :disjunctive-preconditions)
