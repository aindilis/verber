...
(define
 (domain fffopc1)
 (:requirements :conditional-effects :equality :durative-actions :disjunctive-preconditions :derived-predicates :typing :fluents :negative-preconditions :timed-initial-literals)
