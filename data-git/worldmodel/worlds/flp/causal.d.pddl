...
(define
 (domain flpCausal)
 (:requirements :durative-actions :equality :disjunctive-preconditions :fluents :derived-predicates :conditional-effects :negative-preconditions :universal-preconditions :typing :timed-initial-literals)
