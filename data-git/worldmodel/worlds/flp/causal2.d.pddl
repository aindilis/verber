...
(define
 (domain flpCausal2)
 (:requirements :negative-preconditions :disjunctive-preconditions :derived-predicates :typing :timed-initial-literals :conditional-effects :durative-actions :equality :fluents :universal-preconditions)
