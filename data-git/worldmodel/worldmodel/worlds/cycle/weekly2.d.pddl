...
(define
 ...
 (:requirements :typing :fluents :timed-initial-literals :conditional-effects :equality :durative-actions :disjunctive-preconditions :derived-predicates :negative-preconditions)
