...
(define
 (domain CYCLE_WEEKLY1)
 (:requirements :derived-predicates :conditional-effects :disjunctive-preconditions :negative-preconditions :timed-initial-literals :durative-actions :fluents :equality :typing)
