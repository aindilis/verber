...
(define
 (domain date-20120908)
 (:requirements :durative-actions :derived-predicates :negative-preconditions :timed-initial-literals :equality :typing :conditional-effects :disjunctive-preconditions :fluents)
