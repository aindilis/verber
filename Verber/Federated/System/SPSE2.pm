package Verber::Federated::System::SPSE2;
...
has 'RegisteredWorldNames' => (is => 'rw',isa => 'ArrayRef',default => sub {[qw(SYSTEM_SPSE2)]});
...
sub Generate {
  ...
  if (defined $message) {
    ...
    $self->Problem->Problem("system/spse2");
    $self->Problem->Domain("system/spse2");
