package Verber::Federated::Cycle::Years25_1;
...
has 'RegisteredWorldNames' => (is  => 'rw',isa => 'ArrayRef',default => sub {[qw(CYCLE_YEARS25_1)]});
...
sub GenerateProblem {
  ...
  my $dt1;
  if ($args{'Verber::Federated::Cycle::Years25_1'}{Date} =~
