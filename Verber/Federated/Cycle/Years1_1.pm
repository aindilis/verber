package Verber::Federated::Cycle::Years1_1;
...
has 'RegisteredWorldNames' => (is  => 'rw',isa => 'ArrayRef',default => sub {[qw(CYCLE_YEARS1_1)]});
...
sub GenerateProblem {
  ...
  my $dt1;
  if ($args{'Verber::Federated::Cycle::Years1_1'}{Date} =~
