package Verber::Federated::Cycle::Daily1;

# plan out 1 day in advance
...
has 'RegisteredWorldNames' => (is  => 'rw',isa => 'ArrayRef',default => sub {[qw(CYCLE_DAILY1)]});
...
sub GenerateProblem {
  ...
  my $dt1;
  if ($args{'Verber::Federated::Cycle::Daily1'}{Date} =~
